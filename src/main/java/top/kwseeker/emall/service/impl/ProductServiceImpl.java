...
import top.kwseeker.emall.dao.CategoryMapper;
import top.kwseeker.emall.dao.ProductMapper;
...
import top.kwseeker.emall.vo.ProductListVo;
...
public class ProductServiceImpl implements IProductService {
    ...
    /**
     * 通过关键字以及分类分页查询产品信息
     * @param keyword 关键字 like 匹配（TODO: 大数据量下like可能有性能问题，此处如何优化）
     * @param categoryId 不指定的话从所有商品中查询
     */
    //TODO： 优化：通过categoryId查询，如果categoryId下还有子分类，则会循环查询每个子分类下是否有符合关键字的商品
    public ServerResponse<PageInfo> getProductByKeywordCategory(String keyword,Integer categoryId,int pageNum,int pageSize,String orderBy){
        ...
        // 关键字及分类id校验，不然传无效的分类id，查不到数据会执行默认处理显然不符合要求
        if(categoryId != null){
